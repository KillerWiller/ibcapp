                ...
                <div class="tabla-filtro">
                    ...
                    <table id="TablaSedes" class="datatable table table-sortable table-striped table-bordered" >
                        <thead class="table-dark">
                            ...
                            <th style="text-align: center; vertical-align: middle; ">Estado </svg></th>
                            <th></th>
                            <th></th>
                        </thead>
                        <tbody>
                            <?php 
                                $data = json_decode($usuarios->ListaUsuarios());
                                if (count($data->JSedes)>0){
                                    $n=1;
                                    foreach ($data->JSusuarios as $idx => $rs) {
                                        // Output a row
                                        echo "<tr class='table-light   table-hover'>";
                                            echo "<td >$n</td>";
                                            echo "<td>" .$rs->Nombre_Usuario . " " .$rs->Apellido_Usuario." </td>";
                                            echo "<td>$rs->Usuario</td>";
                                            echo "<td>$rs->Status</td>";
                                            echo'<td><a href="SedeEdita.php?nik='.$rs->Id_Usuario .'" title="Editar datos" class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                            </svg></a></td>';
                                            echo'<td><a href="SedeLista.php?aksi=delete&nik='.$rs->Id_Usuario .'" title="Eliminar" onclick="return confirm(\'Esta seguro de borrar los datos de '.$rs->Nombre_Usuario . " " .$rs->Apellido_Usuario.'?\')" class="btn btn-danger btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
