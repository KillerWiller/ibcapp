           ...
           ?>
			...
			<form class="form" action="" method="post" onsubmit="return validar(event)" >
				<div class="card" style="width: 50rem;" >
					<h1 class= "display-4" >Alumnos &raquo; Editar datos</h1> 
					<hr />
					...
					<div class="row g-1">
						<div class="col-sm-3">
							...
							<input type="text" name = "rut" readonly class="form-control-plaintext" id="rut"  value= <?php echo $alumno->frut($RSalumno[0]["Alu_Rut"]); ?>>
						</div>
					</div>
					</br>
					<div class="row g-1">
						<div class="form-floating col-sm-7">
							<input type="text" name="nombres" class="form-control" id="nombres" placeholder="Nombres" value= <?php echo $RSalumno[0]["Alu_Nombres"]; ?> required>
					...
					<div class="row g-2">
						<div class="form-floating col-sm-5">
							<input type="text" name="apePat" class="form-control" id="apePat" placeholder="Apellido Paterno" value= <?php echo $RSalumno[0]["Alu_ApePaterno"]; ?> required>
							<label for="floatingPassword">Apellido Paterno</label>
						</div>
						<div class="form-floating col-sm-5">
							<input type="text" name= "apeMat" class="form-control" id="apeMat" placeholder="Apellido Materno" value= <?php echo $RSalumno[0]["Alu_ApeMaterno"]; ?> required>
					...
					<div class="row g-2">
						<div class="form-floating col-sm-3">
							<input type="date" id="fecNacimiento" name="fecNacimiento" class="form-control" value='<?php echo $RSalumno[0]["Alu_FecNacimiento"]; ?>'>
						</div>
						<div class="form-floating col-sm-3">
					...
					<div class="row g-2">
						<div class="form-floating col-sm-5">
							<input type="text" name="telefono" class="form-control" id="telefono" placeholder="Telefono" value='<?php echo $RSalumno[0]["Alu_telefono"]; ?>' required>
							<label for="floatingPassword">Telefono</label>
						</div>
						<div class="form-floating col-sm-5">
							<input type="email" name= "email" class="form-control" id="email" placeholder="E mail" value='<?php echo $RSalumno[0]["Alu_Email"]; ?> '>
					...
					<div class="row g-2">
						<div class="form-floating col-sm-10">
							<input type="text" name="direccion" class="form-control" id="direccion" placeholder="Direccion"  value='<?php echo $RSalumno[0]["Alu_Direccion"]; ?>'>
					...
					<div class="row g-2">
						<div class="col text-center">
							<input type="submit" name="edit" class="btn btn-primary btn-lg" value="Guardar">
