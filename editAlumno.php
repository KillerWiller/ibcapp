...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Alumnos &raquo; Editar datos</h2>
            <?php
            if(isset($_POST['edit'])){
                $datosAlumno = array();
                ...
                array_push($datosAlumno,$idAlumno,$Nombres,$apePat,$apeMat,$fecNacimiento,$fono,$email,$direccion,$comuna,$congregacion); 
				unset($_POST['']);
                $resul =  $alumno->editaAlumno($datosAlumno);

				if($resul == 1){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Bien hecho! Los datos han sido actualizados con éxito.</div>';
					$alumno = new _Alumno();
				}
				else{
			...
			$RSalumno = $alumno->buscaAlumno($_GET["nik"]);
           ?>

			<hr />
			<form class="form-horizontal border" action="" method="post"  >
                <div class="form-group">
                    <div class="col-sm-2">
                        <input type='hidden'  name='idAlumno' class='form-control' value= <?php echo $RSalumno[0]['Alu_Id']; ?>>
                    </div>
                </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type='text' readonly name='Rut' class='form-control-plaintext' value= <?php echo $alumno->frut($RSalumno[0]["Alu_Rut"]); ?> >
 					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Nombres</label>
					<div class="col-sm-4">
						<input type="text" name="nombres" class="form-control" placeholder="Nombres" value= <?php echo $RSalumno[0]["Alu_Nombres"]; ?> required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="apePat" class="form-control" placeholder="Apellido Paterno" value= <?php echo $RSalumno[0]["Alu_ApePaterno"]; ?>  required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="apeMat" class="form-control" placeholder="Apellido Materno" value= <?php echo $RSalumno[0]["Alu_ApeMaterno"]; ?> required>
					</div>
				</div>                 
				<div class="form-group">
					...
					<div class="col-sm-2">
                        <div class="input-group date" data-provide="datepicker">
                            <input type="text" class="form-control" name="fecNacimiento" value='<?php echo date("d/m/Y", strtotime($RSalumno[0]["Alu_FecNacimiento"])); ?>'>  
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="submit" name="edit" class="btn btn-sm btn-primary" value="Guardar datos">
						<a href="listaAlumnos.php" class="btn btn-sm btn-danger">Cancelar</a>
					</div>
				</div>
			</form>
		</div>
