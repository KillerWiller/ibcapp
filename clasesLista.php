            ...
            <div class="container-sm" style="width: 50%;">
                    <span id="message">
                        ...
                        ?>  
                            ...
                            <button type="button" ddata-bs-toggle="tooltip" data-bs-placement="top"  title="Nueva Clase" class="btn btn-dark"  onclick="location.href='clasesCrear.php'">
                                ...
                                if (count($data->JClases)>0){
                                        ...
                                        foreach ($data->JClases as $idx => $rs) {
                                            // Output a row
                                                ...
                                                echo'<td><a href="clasesEdita.php?nik='.$rs->Id_Clase.'" title="Editar datos" class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
