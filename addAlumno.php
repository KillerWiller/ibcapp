...
<body>
	...
	<div class="container">
		<div class="content">
				...
				?>
			<div class="">
				<form class="form-horizontal border" action="" method="post" onsubmit="return validar(event)" >
					<div class="form-group">
						<label class="col-sm-3 control-label">Rut</label>
						<div class="col-sm-2">
							<input type="text" pattern="[0-9]{7,8}-[0-9kK]{1}" name="Rut" class="form-control" placeholder="12345678-9" oninput="checkRut(this)"  required>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="apePat" class="form-control" placeholder="Apellido Paterno" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="apeMat" class="form-control" placeholder="Apellido Materno" required>
						</div>
					</div>                 
					<div class="form-group">
						...
						<div class="col-sm-2">
							<div class="input-group date" data-provide="datepicker">
								<input type="text" class="form-control" name="fecNacimiento">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="telefono" class="form-control" placeholder="ej. +56123456789" required>
						</div>
					</div>                    
					<div class="form-group">
